         ...
         <div class="row">
            <div class="col-2 bor-bottom-top bor-right padd-right">
               <div class="padd-text mt-4">
                  <a href="http://localhost/YummyMap/member/member.jsp" ><h6 style="color: black" class="font-weight-bold">회원정보 변경</h6></a>
               </div>
               <div class="padd-text">
                  <a href="http://localhost/YummyMap/member/text.jsp" ><h6 style="color: black" class="font-weight-bold">내가 쓴글 보기</h6></a>
               </div>
               <div class="mar-top bor-bottom-or padd-text">
                  <a href="#" ><h6 style="color: black" class="font-weight-bold">회원탈퇴</h6></a>
               </div>
            </div>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>@twitter</td>
         ...
         <div style="position: relative; right: 75px; top: 10px;">
            <button type="button" class="btn btn-danger">삭제</button>
         </div>
         <div class="pd-left-500">
         <div class="btn-toolbar" role="toolbar" aria-label="Toolbar with button groups">
            <div class="btn-group mr-2" role="group" aria-label="First group">
               <button type="button" class="btn bg-or text-white">1</button>
               <button type="button" class="btn bg-or text-white">2</button>
               <button type="button" class="btn bg-or text-white">3</button>
               <button type="button" class="btn bg-or text-white">4</button>
            </div>
         </div>
         </div>
         </div>
